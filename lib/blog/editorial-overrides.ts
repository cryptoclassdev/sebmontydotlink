...
const robostrategyJuly17: EditorialOverride = {
  ...
  textOverrides: {
    ...
    k73278a4a86: ['Paying $2.60 for $1 of assets sounds insane. Sometimes it is. Sometimes it is how the best business development companies grew.'],
    k2b44928ae1: ['At 11:40 AM ET on July 20, BOT last traded at $27.32 against that $10.51 NAV. You are paying 2.60x the fund’s own accounting of its assets, a 160 percent premium. But this is deal flow that you cannot get. That looks irrational until you see the mechanism.'],
    ...
    k1afa34a7f9: ['The price: ', '$27.32 at 11:40 AM ET on July 20 against a $10.51 NAV the fund marks itself. You pay 2.60x book, a 160 percent premium, down from around 4x in late June.'],
    ...
    kbd4c9ab730: ['The token trades under the plain symbol BOT. On July 20, 2026 it was around $27.43 on its largest pool, tracking the Nasdaq stock within a few cents. Pools across Solana held about $214,000 of observed liquidity at the time of this update, though both price and liquidity move constantly.'],
    k045117b0e0: ['The token lives in active, permissionless AMM pools. On July 20, 2026, different pools on Solana held about $214,000 of liquidity and saw about $241,000 of trading volume over the prior 24 hours. You can route into these through Jupiter like any Solana token.'],
    k757b505cfd: ['The token: ', 'real BOT shares held one for one by regulated broker-dealers, tradable around the clock on Raydium, Meteora, and Jupiter at about $27.43 when checked on July 20.'],
    k69adc1e107: ['LP reality: ', 'about $214,000 of observed pool liquidity and about $241,000 of 24-hour trading volume on July 20; income is swap fees only, and divergence can arrive as an overnight jump.'],
    k289dff0766: ['You pay about 2.60x a self-marked NAV, a 160 percent premium. ', 'Most of the portfolio is priced by the fund itself, with no market check.'],
  ...
  blockOverrides: {
    ...
    keccbc87e4b: {
      ...
      dateLabel: 'Figures checked July 20, 2026',
      dateTime: '2026-07-20',
      metrics: [
        { _key: 'nav', label: 'NAV / share', value: '$10.51', detail: 'Latest unaudited NAV · Jun 30', tone: 'gauge' },
        { _key: 'price', label: 'Share price', value: '$27.32', detail: 'Nasdaq last sale · Jul 20, 11:40 AM ET', tone: 'sebring' },
        { _key: 'premium', label: 'Premium to NAV', value: '+160%', detail: 'Share price is 2.60× NAV', tone: 'neutral' },
        { _key: 'low', label: 'All-time low', value: '$19.20', detail: 'May 13 · third trading session', tone: 'neutral' },
      ],
      caption: 'Share price uses the Nasdaq last sale at 11:40 AM ET on July 20; NAV is the fund’s latest published unaudited mark as of June 30.',
      ariaLabel: 'RoboStrategy market snapshot checked July 20, 2026. NAV per share 10 dollars 51 cents. Share price 27 dollars 32 cents at 11:40 AM Eastern Time. Premium to NAV 160 percent, or 2.60 times NAV. All-time low 19 dollars 20 cents.',
    },
    kf457c545a9: {
      _key: 'kf457c545a9',
      _type: 'stackedBar',
    ...
    k7f39f8317f: {
      ...
      source: 'Sources: RoboStrategy NAV update, Jun 30 2026 · Nasdaq last sale, Jul 20 2026, 11:40 AM ET',
      title: 'Of the $27.32 you pay, $10.51 is book. The rest is the bet.',
      sharePrice: { label: 'Share price', value: 27.32, displayValue: '$27.32' },
      bookValue: { label: 'NAV', value: 10.51, displayValue: '$10.51' },
      premium: { label: 'Premium', value: 16.81, displayValue: '$16.81' },
      multipleLabel: '2.60× book',
      navHistory: [
      ...
      caption: 'The Nasdaq last sale at 11:40 AM ET on July 20 was 2.60× the fund’s June 30 NAV per share. The premium is the market’s bet that the private holdings keep compounding.',
      ariaLabel: 'Premium-to-NAV exhibit checked July 20, 2026. RoboStrategy shares last traded at 27 dollars 32 cents at 11:40 AM Eastern Time. The fund reported NAV of 10 dollars 51 cents per share on June 30, leaving a 16 dollar 81 cent premium, or 2.60 times book value.',
    },
    k6974ce5ac6: {
      _key: 'k6974ce5ac6',
    ...
    k013d407166: {
      ...
      title: 'BOT fell from $59 to $27.32. NAV was still only $10.51.',
      source: 'Sources: Nasdaq last sale, Jul 20 2026, 11:40 AM ET · RoboStrategy NAV updates',
      ...
      price: [
        ...
        { position: .96, value: 29.25, date: 'Jul 16' },
        { position: 1, value: 27.32, date: 'Jul 20', label: '$27.32 last sale' },
      ],
      nav: [
        { position: .35, value: 7.24, date: 'May 31' },
        { position: .7, value: 10.51, date: 'Jun 30' },
        { position: 1, value: 10.51, date: 'Jul 20', label: 'NAV $10.51' },
      ],
      caption: 'The share price travelled from a $59 debut high to a $19.20 all-time low, then last traded at $27.32 at 11:40 AM ET on July 20. The June 30 NAV remained $10.51 per share throughout the latest stretch.',
      ariaLabel: 'BOT share price and NAV timeline. Share price began at 59 dollars on May 11, reached a 19 dollar 20 cent low on May 13, and last traded at 27 dollars 32 cents at 11:40 AM Eastern Time on July 20. The latest NAV was 10 dollars 51 cents per share.',
    },
    k47d1e99058: {
      _key: 'k47d1e99058',
      _type: 'priceTimeline',
    ...
    kfa7cdfad1a: {
      ...
      dateLabel: 'Observed July 20, 2026',
      primary: {
        name: 'BOT',
        issuer: 'RoboStrategy · Backpack Securities',
        status: '1:1-backed share token',
        metrics: [
          { label: 'Observed price', value: '$27.43', tone: 'gauge' },
          { label: 'Observed 24h volume', value: '$241k', tone: 'marigold' },
          { label: 'Observed liquidity', value: '$214k', tone: 'gauge' },
      ...
      comparison: {
        ...
        metrics: [
          { label: 'DEX market', value: 'N/A' },
          { label: 'DEX volume', value: 'N/A', tone: 'redline' },
          { label: 'DEX liquidity', value: 'N/A' },
      ...
      ariaLabel: 'Token comparison checked July 20, 2026. BOT was observed around 27 dollars 43 cents with about 241 thousand dollars of 24-hour volume and about 214 thousand dollars of observed liquidity. BOTon has no observed DEX market, volume, or liquidity.',
    },
    k33e75ff09d: null,
  },
}
