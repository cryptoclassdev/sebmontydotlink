...
export function LinkBioPage() {
  ...
  const maskImage = useMotionTemplate`radial-gradient(18.75rem circle at ${mouseX}px ${mouseY}px, black, transparent)`
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0">
        <div className="absolute right-[-20%] top-[-20%] w-[40%] h-[40%] rounded-full bg-orange-500/40 dark:bg-orange-600/20 blur-[7.5rem]" />
        <div className="absolute right-[10%] top-[-10%] w-[20%] h-[20%] rounded-full bg-primary/30 blur-[6.25rem]" />
        <div className="absolute left-[-10%] bottom-[-20%] w-[40%] h-[40%] rounded-full bg-blue-500/40 dark:bg-blue-600/20 blur-[7.5rem]" />
      </div>
      ...
      <motion.div
        ...
        className="relative z-10 mx-auto max-w-[25rem] w-full flex flex-col flex-1 justify-between"
      >
